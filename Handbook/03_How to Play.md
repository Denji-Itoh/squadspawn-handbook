...
There are the following 17 skills, the first 5 are *Combat Skills*, whereas *Ability* can also be used outside of combat: 
...
* Defence – Can you take a hit without getting hurt? (This is a defender check that will be used for attacks you're not aware of or that cover a wide are of effect.)
* Dexterity – Are you more of a fast-moving type and prefer dodging hits? (This is a defender check that also affects your initiative roll.)
...
## Action Economy
Action Economy is the term used to describe what you can make your character do over the course of a full round. It is usually ignored unless necessary due to stressful situations or characters acting against each other in a combat encounter. One turn takes 5s. 

These are the type of actions available to your character: 
* Main Action: With this action type you can launch attacks, grapple or disarm an enemy, attempt to pick locks or use half your movement (rounded down) again. You can also try and end certain conditions with your main action. It's also possible to use the Help Action to give an ally advantage on a roll, or the Sabotage Action to give a creature disadvantage on a roll. 
* Bonus Action: With your bonus action you can, depending on your race and class choices, sometimes do additional things on your turn. Every Bonus Action activity can also be performed as a Main Action. 
* Interaction: You can interact with one item. This includes opening doors, windows, grabbing things out of your backpack and such. It doesn't include any activity that'd require a check or is otherwise ruled as too time expensive by your GM, such as picking locks. 
* Reaction: You can take the Help Reaction when an ally is about to be hit with an attack, or make an Opportunity Attack when an enemy is leaving your melee range of 1m. Depending on your race and class you might gain additional activities to do as your Reaction. 
...
* The higher your check is, the earlier you can start your turn. If you were the one to initiate combat however, you have advantage on your Initiative Roll. 
...
* When a creature attacks, they roll for their desired attack roll (Ranged or Close-Combat) and the target creature has to roll for their desired (or required) defender roll (Defence or Dexterity). The winner of the contest gets to describe the outcome and roll for an attack. 
...
* Both Attack and Damage rolls are made once per attack, not per creature hit by the attack in the case of field covering attacks. 
...
### Invisibility
* An invisible creature is not 100% imperceptible. They create sounds, smell, leave footprints or have rustling equipment, and they still emit aura, which other creatures can detect passively or actively. 
* An invisible creature can't receive the Help Reaction, as it is too difficult to keep track of their location and status passively while in a fight. 
* A creature can try and discover the location or presence of an invisible creature, making either an Observance vs. Stealth or a Focus vs. Ability contest, at the choice of the initiator. If the contest is won by the initiator, they can now target the invisible creature for an attack and know of their presence. 
* The invisible creature can make their defender check with advantage. 
